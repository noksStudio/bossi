...
export const DBPLAST_CUSTOMERS: DemoCustomer[] = [
  {
    name: 'בית ספר יסודי הדר',
    legal: 'עיריית רמת גן — אגף חינוך',
    businessId: '500210448',
    terms: 60,
    creditLimit: '45000.00',
    tags: ['מוסדי', 'לקוח קבוע'],
    weight: 9,
    contacts: [
      { name: 'רונית שגיב', roles: ['orders', 'approves'], email: 'ronit@hadar-school.org.il', phone: '03-570-2210', primary: true },
      { name: 'הנהלת חשבונות עירייה', roles: ['pays'], email: 'ap@ramat-gan.muni.il' },
    ],
  },
  {
    name: 'תיאטרון הבמה',
    legal: 'תיאטרון הבמה (ע״ר)',
    businessId: '580332217',
    terms: 45,
    creditLimit: '60000.00',
    tags: ['לקוח קבוע'],
    weight: 8,
    contacts: [{ name: 'עידו כרמל', roles: ['orders', 'approves', 'pays'], email: 'ido@habama-theater.co.il', phone: '054-320-1187', primary: true }],
  },
  {
    name: 'מפעל הריפוד המרכזי',
    legal: 'הריפוד המרכזי תעשיות בע״מ',
    businessId: '511667234',
    terms: 60,
    creditLimit: '180000.00',
    tags: ['תאגיד', 'לקוח קבוע', 'ותיק'],
    weight: 10,
    contacts: [
      { name: 'משה אזולאי', roles: ['approves'], primary: true },
      { name: 'רכש', roles: ['orders'], phone: '052-660-4471', email: 'purchasing@ripud-hamerkazi.co.il' },
      { name: 'הנהלת חשבונות', roles: ['pays'], email: 'ap@ripud-hamerkazi.co.il' },
    ],
  },
  {
    name: 'סטודיו תפירה של יעל',
    businessId: '303345217',
    terms: 15,
    tags: ['פרטי'],
    weight: 5,
    contacts: [{ name: 'יעל אבני', roles: ['orders', 'approves', 'pays'], phone: '050-224-9931', primary: true }],
  },
  {
    name: 'מכללת הדסה — עיצוב אופנה',
    legal: 'הדסה מכללה ירושלים',
    businessId: '500118827',
    terms: 45,
    creditLimit: '30000.00',
    tags: ['מוסדי'],
    weight: 6,
    contacts: [{ name: 'ד״ר שרון פרץ', roles: ['orders', 'approves'], email: 'sharon@hadassah-col.ac.il', primary: true }],
  },
  {
    name: 'דנה לוי — הפקות אירועים',
    businessId: '028661193',
    terms: 15,
    tags: ['פרטי', 'לקוח מזדמן'],
    weight: 3,
    quietDays: 71,
    contacts: [{ name: 'דנה לוי', roles: ['orders', 'pays'], phone: '053-118-2260', primary: true }],
  },
  {
    name: 'רשת בתי אבות שקד',
    legal: 'שקד אחזקות ונכסים בע״מ',
    businessId: '514229907',
    terms: 60,
    creditLimit: '95000.00',
    tags: ['מוסדי', 'תאגיד'],
    weight: 8,
    contacts: [
      { name: 'איריס נחום', roles: ['orders'], email: 'iris@shaked-homes.co.il', primary: true },
      { name: 'כספים', roles: ['approves', 'pays'], email: 'finance@shaked-homes.co.il' },
    ],
  },
  {
    name: 'אולפן קולנוע פאתוס',
    legal: 'פאתוס הפקות בע״מ',
    businessId: '515882201',
    terms: 30,
    tags: ['לקוח מזדמן'],
    weight: 4,
    contacts: [{ name: 'טל רגב', roles: ['orders', 'approves', 'pays'], email: 'tal@pathos-films.co.il', phone: '052-991-4408', primary: true }],
  },
  {
    name: 'בוטיק בדי הבית',
    legal: 'בדי הבית שיווק בע״מ',
    businessId: '514007732',
    terms: 30,
    creditLimit: '20000.00',
    tags: ['לקוח קבוע'],
    weight: 6,
    contacts: [{ name: 'נועה שדה', roles: ['orders', 'approves', 'pays'], email: 'noa@habayit-fabrics.co.il', phone: '050-772-6631', primary: true }],
  },
];
